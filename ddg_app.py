...
# Initialize ALL output variables here (default or placeholder)
L_param = 0.0
k_param = 0.0
t_range = 0
mass_const = 0.0
...
if pe_id == "LS2-1 (Population Dynamics)":
    ...
    # CRITICAL ADDITION: Stop here if no PE is selected to prevent bad submission
    st.stop() 
...
# --- 4. DATA SUBMISSION LOGIC (FINAL ROBUST BLOCK) ---
...
if st.button("Generate Synthetic Data"):
    ...
    # These variables now hold the correct slider values from the executed blocks above
    url_params = {
        PE_ID_ENTRY: pe_id,       
